...
pub use methods::{
    ...
    CreateChannelResponse, CreateTunnelResponse, MakeTunnelCallResponse,
    OPNUM_TS_PROXY_AUTHORIZE_TUNNEL, OPNUM_TS_PROXY_CLOSE_CHANNEL, OPNUM_TS_PROXY_CLOSE_TUNNEL,
    OPNUM_TS_PROXY_CREATE_CHANNEL, OPNUM_TS_PROXY_CREATE_TUNNEL, OPNUM_TS_PROXY_MAKE_TUNNEL_CALL,
    OPNUM_TS_PROXY_SEND_TO_SERVER, OPNUM_TS_PROXY_SETUP_RECEIVE_PIPE,
    TSG_TUNNEL_CALL_ASYNC_MSG_REQUEST, TSG_TUNNEL_CANCEL_ASYNC_MSG_REQUEST,
};
pub use types::{
    ContextHandle, TsEndpointInfo, TsgAsyncMessage, TsgNapCapability, TsgPacket, TsgPacketAuth,
    TsgPacketCapabilities, TsgPacketCapsResponse, TsgPacketHeader, TsgPacketMsgRequest,
    TsgPacketMsgResponse, TsgPacketQuarEncResponse, TsgPacketQuarRequest, TsgPacketReauth,
    TsgPacketReauthMessage, TsgPacketResponse, TsgPacketStringMessage, TsgPacketVersionCaps,
    TsgRedirectionFlags, TsgReauthInitialPacket, TSG_ASYNC_MESSAGE_CONSENT_MESSAGE,
    TSG_ASYNC_MESSAGE_REAUTH, TSG_ASYNC_MESSAGE_SERVICE_MESSAGE, TSG_CAPABILITY_TYPE_NAP,
    TSG_COMPONENT_ID_TR, TSG_MESSAGING_CAP_CONSENT_SIGN, TSG_MESSAGING_CAP_REAUTH,
    TSG_MESSAGING_CAP_SERVICE_MSG, TSG_NAP_CAPABILITY_IDLE_TIMEOUT, TSG_NAP_CAPABILITY_QUAR_SOH,
    TSG_PACKET_TYPE_AUTH, TSG_PACKET_TYPE_CAPS_RESPONSE, TSG_PACKET_TYPE_HEADER,
    TSG_PACKET_TYPE_MESSAGE_PACKET, TSG_PACKET_TYPE_MSGREQUEST_PACKET,
