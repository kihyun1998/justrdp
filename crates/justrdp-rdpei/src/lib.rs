...
pub use pdu::{
    ...
    EVENTID_SUSPEND_INPUT, EVENTID_TOUCH, HEADER_SIZE, MAX_CONTACTS_PER_FRAME,
    MAX_FRAMES_PER_EVENT, ORIENTATION_MAX, PRESSURE_MAX, RDPINPUT_PROTOCOL_V100,
    RDPINPUT_PROTOCOL_V101, RDPINPUT_PROTOCOL_V200, RDPINPUT_PROTOCOL_V300,
};
