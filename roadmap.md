...
- [ ] **CacheBitmapV2Compressed / V1 / V3** — RLE-compressed bitmap cache, V1 layout 차이, V3 (RDP 6.0 multi-bpp 단일 슬롯). 후속 — S3d-6c2
- [ ] **MemBlt 기타 ROP** — destination read-back 필요 (S3d-6h 와 동일 의존)
