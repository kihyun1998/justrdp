...
- [ ] **wasm-bindgen JsClient 클립보드 API** — `attachClipboardChannel(result)` + `setLocalText` (UTF-16 인코드) + `pollRemoteText` (UTF-16 디코드) — S5b
- [ ] 클립보드 API 통합 (Clipboard API browser-side `navigator.clipboard.readText/writeText`) — S5b
