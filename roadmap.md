...
- [ ] **AVC444** — `justrdp_graphics::AvcDecoder` 가 trait 형태 (concrete H.264 decoder 미동봉; embedder 가 외부 H.264 decoder 또는 browser MediaSource 를 trait impl 로 주입). BitmapRenderer 에 `set_avc_decoder<D: AvcDecoder>(decoder)` 형태로 후속 작업 — S3d-5b
