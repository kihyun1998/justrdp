...
- [x] **CacheBitmapV3** (codec_id=0 raw 32/24 bpp) — TS_BITMAP_DATA_EX 헤더 + 옵션 EX 헤더 + 페이로드. codec-encoded V3 (RFX/NSCodec/ClearCodec/AVC) 는 헤더만 파싱, 페이로드는 Surface Bits 디스패치 통합 후속 — S3d-6c5b (S3d-6c5)
