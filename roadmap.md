...
- [x] **`GlyphCacheRevision` enum + `set_glyph_cache_revision`** — 서버가 negotiate 한 V1/V2 revision (default V1) 을 embedder 가 셋. V2 entries 는 현재 silent drop — wire 파서는 후속 — S3d-6d4 (S3d-6d3)
