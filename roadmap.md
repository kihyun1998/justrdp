...
- [ ] **NLA 어댑터 (native)** — `CredsspDriver` 구현체로 `justrdp-connector::
      CredsspSequence` + 플랫폼 NTLM (Windows: SSPI / Linux+macOS: 기존 NTLM
      모듈) 통합. browser 의 "external pre-auth" 모드와 대비되는 in-band 경로
